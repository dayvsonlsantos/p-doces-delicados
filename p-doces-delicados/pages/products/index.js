// pages/products/index.js (CORRIGIDO)
...
export default function Products() {
  ...
  return (
    <Layout activePage="products">
      {/* 🔥 CORREÇÃO: Container principal com overflow-hidden */}
      <div className="min-h-screen flex flex-col overflow-hidden">
        {/* 🔥 CORREÇÃO: Header com controle de overflow */}
        <div className="flex items-center justify-between mb-6 md:mb-8 flex-col sm:flex-row gap-4 sm:gap-0 flex-shrink-0">
        ...
        {/* 🔥 CORREÇÃO: Container do conteúdo com altura controlada */}
        <div className="flex-1 overflow-hidden">
          <GlassCard className="p-4 md:p-6 h-full overflow-hidden">
            {/* 🔥 CORREÇÃO: Container da lista com scroll controlado */}
